...
//      $allocations = \App\Models\inventory\allocations::join('users','users.user_code','=','inventory_allocations.sales_person')
...
//      }
      ...
      return view('livewire.dashboard.allocations', compact('salesPerson','allocations', 'count'));
    }
}
