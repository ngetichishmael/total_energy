      ...
      <div class="bookmark-wrapper d-flex align-items-center">
         ...
         <ul class="nav navbar-nav bookmark-icons">
            <li class="nav-item d-none d-lg-block">
               <a class="nav-link" href="#" title="Chat"><i class="ficon" data-feather="message-square"></i></a>
            </li>
         </ul>
      ...
      <ul class="nav navbar-nav align-items-center ms-auto">
         ...
         <li class="nav-item dropdown dropdown-user">
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
               ...
               <span class="avatar">
                  <img src="https://ui-avatars.com/api/?name={!! Auth::user()->name !!}&rounded=true&size=80" alt="profile image" class="round" height="40" width="40" />
               ...
               <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                  ...
                  <a class="dropdown-item" href="#"><i class="me-50" data-feather="briefcase"></i> Business Profile</a>
