            ...
            <li class="nav-item {!! Nav::isResource('orders') !!}">
                ...
                <ul class="menu-content">
                    <li style="padding-left: 20px"><a class="d-flex align-items-center"
                            ...
                            <i data-feather="circle"></i>  <span class="menu-item text-truncate">Pending Orders</span></a>
                    </li>
                    <li style="padding-left: 20px"><a class="d-flex align-items-center"
                            href="{{ route('orders.pendingdeliveries') }}">
                            <i data-feather="circle"></i>  <span class="menu-item text-truncate">Pending Deliveries</span></a>
                    </li>
                    <li style="padding-left: 20px"><a class="d-flex align-items-center" href="{!! route('delivery.index') !!}">
                        <i data-feather="circle"></i>  <span class="menu-title text-truncate" data-i18n="Todo">
                                Delivery History</span>
                        </a>
                    </li>
                    <li style="padding-left: 20px"><a class="d-flex align-items-center" href="{!! route('orders.vansalesorders') !!}">
                        <i data-feather="circle"></i> <span class="menu-title text-truncate" data-i18n="Todo">
            ...
            <li class="nav-item {!! Nav::isResource('regions') !!}">
                ...
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center{!! Nav::isResource('route-schedulw') !!}" href="{!! route('routes.index') !!}"><i
                                    data-feather="map-pin"></i><span class="menu-item text-truncate">Route Scheduling</span></a>
                        </li>
