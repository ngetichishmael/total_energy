...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <h1 class="text-gray-200">Total Privacy Policy</h1>
            <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm p-6">
                    <h3 class="">Last updated: February 22, 2023</h3>
                    <p>
                ...
                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm p-6">
                    ...
                    <ul>
                        <li>By email: <strong>info@deveint.com</strong></li>
                        <li>By phone number: <strong>+254 748424757</strong></li>
                    </ul>
                </div>
            </div>
        </div>
