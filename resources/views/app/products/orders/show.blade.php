                        ...
                        <table class="table table-striped">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="" colspan="2">{!! $order->code !!} {!! number_format($order->cart->totalPrice)  !!}</td>
                              </tr>
                              ...
                              <tr class="mw-ui-table-footer last">
                                 ...
                                 <td class="" colspan="2"><strong>{!! $order->code !!} {!! number_format($order->cart->totalPrice)  !!}</strong></td>
                              </tr>
                           </tbody>
                        </table>
                     </div>
