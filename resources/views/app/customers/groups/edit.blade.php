      ...
      <div class="row">
                     ...
                     <table id="data-table-default" class="table table-striped table-bordered">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>{!! $group->name !!}</td>
                              <td>
                                 <a href="{!! route('finance.contact.groups.edit',$group->id) !!}" class="btn btn-pink"><i class="far fa-edit"></i> Edit</a>
                                 <a href="{!! route('finance.contact.groups.delete',$group->id) !!}" class="btn btn-danger delete"><i class="fas fa-trash"></i> Delete</a>
                              </td>
                           </tr>
                           @endforeach
                        </tbody>
         ...
         <div class="col-md-6">
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  <div class="panel-body">
                     {!! Form::model($edit, ['route' => ['finance.contact.groups.update',$edit->id], 'method'=>'post','enctype'=>'multipart/form-data']) !!}
                        @csrf
