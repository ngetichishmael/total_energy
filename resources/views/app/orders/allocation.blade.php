...
<div class="bs-stepper checkout-tab-steps">
  ...
  <div id="customer-details" class="content">
      <form class="list-view product-checkout" action="{!! route('order.create.delivery') !!}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="row">
              <div class="col-md-3 col-sm-12">
                <div class="form-group mb-2">
                  <label for="checkout-name">Choose Account Type:</label>
              ...
              <div class="col-md-3 col-sm-12">
                <div class="form-group mb-2">
                  <label for="checkout-name">Choose User:</label>
              ...
              <div class="col-md-3 col-sm-12">
                <div class="form-group mb-2">
                  <label for="checkout-name">Warehouse:</label>
