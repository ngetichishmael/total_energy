...
@section('content')
   ...
   <div class="row mb-2">
      <div class="col-md-8">
         <h2 class="page-header"><i data-feather="list"></i> Visits | Edit </h2>
      </div>
   </div>
   <!-- end breadcrumb -->
   <!-- begin page-header -->
      ...
      <div class="col-8">
          <div class="card">
              <div class="card-header">
                  <h4 class="card-title">Update Visits Targets</h4>
              </div>
              <div class="card-body">
                  <form class="form" method="POST"
                      action="{{ route('visitstarget.update',$edit->user_code) }}">
                      @csrf
                      <div class="row">
