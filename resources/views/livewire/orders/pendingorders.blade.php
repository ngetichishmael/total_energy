                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($order->payment_status === 'PAID')
                                        <span
                                            class="badge badge-pill badge-light-success mr-1">{{ $order->payment_status ?? '' }}</span>
                                    @else
                                        <span
                                            class="badge badge-pill badge-light-warning mr-1">{{ $order->payment_status ?? '' }}</span>
                                    @endif
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-sm dropdown-toggle show-arrow"
                                            data-toggle="dropdown" style="background-color:#1877F2; color:white">
