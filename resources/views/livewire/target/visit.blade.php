                ...
                <tbody>
                    @forelse ($targets as $key=>$target)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $target->name }}</td>
                            <td>{{ $target->TargetsVisit->VisitsTarget ?? 0 }}</td>
                            <td>{{ $target->TargetsVisit->AchievedVisitsTarget ?? 0 }}</td>
                            <td>{{ $target->TargetsVisit->Deadline ?? '' }}</td>
                            <td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a href="{{ route('visitstarget.edit', $target->user_code) }}" type="button"
                                            class="dropdown-item btn btn-sm" style="color:#7cc7e0 ;font-weight: bold"><i
                                                data-feather="edit"></i>
                                            &nbsp;Edit</a>
                                        <a href="{{ route('visit.target.show', [
