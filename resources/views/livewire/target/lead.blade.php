            ...
            <div class="pt-0 pb-2 d-flex justify-content-between align-items-center mx-50 row">
             ...
             <div class="col-md-6 d-flex justify-content-end">
                    <div class="demo-inline-spacing">
                        <a href="{{ route('leads.target.create') }}" class="btn btn-outline-secondary">New Target</a>
                            ...
                            <div class="dropdown">
                                    <button type="button" class="btn btn-sm dropdown-toggle show-arrow " data-toggle="dropdown" style="background-color:#1877F2; color:#ffffff;">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{ route('leadstarget.edit', $target->user_code) }}">
                                                <i data-feather='edit' class="mr-50"></i>
                                                <span>Edit</span>
                                            </a>
                                            <a class="dropdown-item" href="{{ route('leads.target.show', [
