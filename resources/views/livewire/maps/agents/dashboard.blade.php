...
<script>
    ...
    function initMarkers() {
        ...
        for (let index = 0; index < initialMarkers.length; index++) {
            var image = new google.maps.MarkerImage("{{ asset('app-assets/images/pin.png') }}", null, null, null,
            ...
            />
              <h1 id="firstHeading" class="firstHeading">${markerData.title}</h1>
                  <div id="bodyContent">
                      ...
                      <p><b>Customer Name: </b>${markerData.title}
                       <p><b>battery Level: </b>${markerData.battery}
                       <p><b>Android Version: </b>${markerData.android_version}
                       <p><b>IMEI: </b>${markerData.IMEI}
                      <p><b>Time: </b>${markerData.description}
