                ...
                <table class="table table-striped table-bordered zero-configuration table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{!! route('delivery.details', $deliver->order_code, $deliver->User->name ?? '') !!}" class="btn btn-sm btn"
                                    style="background-color:#1877F2; color:#ffffff;">View</a></td>
                        </tr>
                        @endforeach
                        </tr>
                    </tbody>
