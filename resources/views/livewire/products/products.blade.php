			...
			<td>
			   {!! $product->category !!}
                        ...
                        <td>
                           ...
                           <a href="{{ route('products.edit', $product->proID) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
                           <a href="{!! route('products.destroy', $product->proID) !!}" class="btn btn-danger delete btn-sm"><i class="fas fa-trash"></i></a>
                        </td>
                     </tr>
                  @endif
               @endforeach
