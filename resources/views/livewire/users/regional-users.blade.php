    ...
    <div class="card">
        ...
        <div class="pt-0 pb-2 d-flex justify-content-between align-items-center mx-50 row">
            ...
            <div class="col-md-2">
                ...
                <a class="btn btn" style="background-color:#4395d1; color:#ffffff;" href="{!! route('user.create') !!}"> <i
                    ...
                    <tbody>
                        @foreach ($users as $key => $user)
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn dropdown-toggle mr-2"
                                            style="background-color:#4395d1; color:#ffffff; padding: 6px 14px; font-size: 12px;"
                                            type="button" id="dropdownMenuButton" data-bs-trigger="click"
