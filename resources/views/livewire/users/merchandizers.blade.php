<div>
    ...
    <tbody>
        @forelse ($merchandizer as $key => $user)
            <tr>
                <td>{!! $key + 1 !!}</td>
                <td>{!! $user->name !!}</td>
                <td>{!! $user->email !!}</td>
                        ...
                        <div class="dropdown-menu">
                            ...
                            @if ($user->status == 'Active')
                                <a wire:click.prevent="deactivate({{ $user->id }})"
                                    onclick="confirm('Are you sure you want to DEACTIVATE this Merchandizer?')||event.stopImmediatePropagation()"
                                    class="dropdown-item">
                            ...
                            @else
                                <a wire:click.prevent="activate({{ $user->id }})"
                                    onclick="confirm('Are you sure you want to ACTIVATE this Merchandizer?')||event.stopImmediatePropagation()"
                                    class="dropdown-item">
        ...
        @endforelse
            ...
            <div class="mt-1">{!! $merchandizer->links() !!}</div>
        </div>
    </div>
<br>
