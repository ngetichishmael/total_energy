...
//warehouses
    ...
    Route::post('/stock/create/request/{warehouse_code}', [StockRequisitionController::class, "store"])->middleware('auth:sanctum');
    ...
    // Reconcillations
    Route::get('/reconcile/payment', 'Api\ReconciliationController@index')->middleware('auth:sanctum');
    Route::post('/reconcile/products', 'Api\ReconciliationController@index')->middleware('auth:sanctum');
 ...
 */
    ...
    //Customers
    Route::get('/get/ui/customers', 'CustomerDataController@getCustomers')->name('getUICustomers');
